...
namespace DM.Web.SL.Controls.Validator
{
    ...
    public class LengthAloneValidator : ValidatorAloneBase
    {
        ...
        public static readonly DependencyProperty MaxLengthProperty =
            DependencyProperty.Register("MaxLength", typeof(double), typeof(LengthAloneValidator),
        ...
        public static readonly DependencyProperty MinLengthProperty =
            DependencyProperty.Register("MinLength", typeof(double), typeof(LengthAloneValidator),
