...
namespace DM.Client.WPF.Controls.NotifyMessage.Interop
{
  ...
  public struct NotifyIconData
  {
    ...
    /// For example, setting this member to <see cref="DM.Client.WPF.Controls.NotifyMessage.Interop.IconState.Hidden"/>
    ...
    /// of the tray icon. If this member is non-NULL and the <see cref="DM.Client.WPF.Controls.NotifyMessage.Interop.BalloonFlags.User"/>
